...
Figures were generated using Python (version 3.6.3) and the following packages: `numpy` (version 1.14.2), `pandas` (version 0.22.0), `matplotlib` (version 2.2.2).  Figures can be generated by running the script [`run.sh`](run.sh) from the main project folder.  
